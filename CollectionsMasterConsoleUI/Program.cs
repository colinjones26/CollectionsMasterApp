...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Last number in array: " + numbers[numbers.Length - 1]);
            ...
            */
            ...
            Console.WriteLine("List converted to Arrary:");
            NumberPrinter(numberArray);

            //TODO: Clear the list
            numberList.Clear();
            Console.WriteLine("List cleared. New Capacity: " + numberList.Capacity);
